...
- **Persistencia Local:**
  - `DataStore Preferences`: Administrador moderno (reemplazo del anticuado Shared Preferences) para almacenar el identificador del usuario, su JWT, correo y rol con bajo consumo asíncrono.
