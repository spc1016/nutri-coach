...
*   **Clonación de Planes Interactiva (Social Sharing):** Los usuarios pueden adjuntar una de sus **Dietas o Rutinas** directamente a sus posts. Cuando otro miembro de la comunidad ve el post, puede pulsar sobre el adjunto para revisar el plan de ejercicios o comidas en detalle y, con un solo toque, **clonar / replicar** esa rutina o dieta completa directamente en su perfil personal.
